...
//->
long DRTDBEXPORTS DRTDBAPI DRTDB_GetNextTagNode(long &lTagID, _TAG_NODE &TagNode);
//->added by yurui, 04/02/18
long DRTDBEXPORTS DRTDBAPI DRTDB_FindTagBySource(LPSTR sourcename, _TAG_NODE &tagnode);
//->
...
long DRTDBEXPORTS DRTDBAPI DRTDB_MD_FindTagBySource(LPSTR sDeviceName, LPSTR sourcename, _TAG_NODE &tagnode);
...
long DRTDBEXPORTS DRTDBAPI DRTDB_MD_GetNextTagNode(LPSTR sDeviceName, long &lTagID, _TAG_NODE &TagNode);
